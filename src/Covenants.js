        ...
        return (
            <div id="covenants-page">
                ...
                <h1 className="cov-header"> Protective Covenants </h1>
                    ...
                    <p className="covenants">
                        The floor area, commonly referred to as living area or heated and cooled area, of the ground floor of the main structure, excluding garage and porches, shall not be less than 1550 square feet.  All structures are to be built of new materials. All materials must be approved by the developer as to type and quality. Only one primary residence may be constructed on the property described in the Deed attached hereto, and shall not be subdivided into additional lots, unless developer waives with written approval. It being the intent of the developer to preserve the integrity of the development.
                    </p>
                    <p className="covenants">
                    ...
                    <ol>
                        <li className="covenants">
                        Commercial activities of any kind.
                        </li>
                        <li className="covenants">
                        Signs, other than property for sale signs.
                        </li>
                        <li className="covenants">
                        Any automobile that does not have a current license plate and inspection sticker. Long term outside storage of any automobile. Large commercial vehicles. Automobile parking in front yard.
                        </li>
                        <li className="covenants">
                        Junk of any kind.
                        </li>
                        <li className="covenants">
                        Manufactured or Mobile homes or large trucks, except for delivery activities to property. Tractor or other machinery, except lawn care equipment for use on premises.
                        </li>
                        <li className="covenants">
                        Motor homes, travel trailers, trailers, off road vehicles and boats unless stored inside a closed garage.
                        </li>
                        <li className="covenants">
                        Permanent or overnight parking on road or road right-of-way.
                        </li>
                        <li className="covenants">
                        Radio and TV antennas that are visible from roadway. Visible TV satellite dishes exceeding 18” in diameter.
                        </li>
                        <li className="covenants">
                        Outside storage cluttering of any abandoned materials/objects that might impair the integrity of the development.
                        </li>
                        <li className="covenants">
                        Hunting or discharge of firearms.
                        </li>
                        <li className="covenants">
                        Clothes lines, unless completely hedged from neighboring view and view of roadway.
                        </li>
                        <li className="covenants">
                        Above ground swimming pools, unless hidden behind privacy fence.
                        </li>
                    </ol>      
                    <p className="covenants">
