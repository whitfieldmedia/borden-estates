...
import house from './assets/images/588/588_house_plan.png';
import floorplan from './assets/images/588/588_floor_plan.png';
        ...
        return (
            <div className="house-container">
                ...
                <div className="detail-row">
                    ...
                    <div className="detail-row">
                        <p className="detail-header"> Living Area </p><p className="details"> 1,747 sqft </p>
                    </div>
                    <div className="detail-row">
...
// https://www.nelsondesigngroup.com/content/house-plan-588-cypress