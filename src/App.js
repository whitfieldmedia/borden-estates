      ...
      <div className="app">
        <div className="navbar">
          <div className="nav-row">
            ...
            <span className="toggle-button" onClick={this.toggleMenu}> {this.state.isToggled ? <i className="material-icons md-36">close</i> : <i className="material-icons md-36">menu</i> } </span>
          </div>
